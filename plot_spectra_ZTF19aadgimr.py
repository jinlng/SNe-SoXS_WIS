...
data_dicts = Read_data.read_data_Marshall_simple(
    '/home/jinlng/test_dir/Type_IIn/ZTF19aadgimr/ZTF19aadgimr_data_Marshal.txt',
...
spec_1 = class_spectrum.spectrum(path_to_data=
    '/home/jinlng/test_dir/Type_IIn/ZTF19aadgimr/ZTF19aadgimr_20190204_NOT_v1.ascii',    # good to go but time unclear
...
spec_2 = class_spectrum.spectrum(path_to_data=
    '/home/jinlng/test_dir/Type_IIn/ZTF19aadgimr/SN2019qt_2019-01-13_03-42-54_UH88_SNIFS_TNS.dat',
    instrument='UH88',skiprows=0,time='2019-01-13T15:42:55',time_format='utc',show=False)   #time checked
spec_2_cal = spec_2.calibrate(array_of_calibrating_data=P48_r_array,
    filter_family='ztf_p48',filter_name='r_p48',filters_directory=filters_directory)



spectra = [spec_2, spec_1]
spectra_cal = [spec_2_cal, spec_1_cal]
...
annotations = [(spec_1_cal[-1, 0]+100,np.min(spec_1_cal)+offsets[1]),(spec_2_cal[-1, 0]+100,np.min(spec_2_cal)+offsets[0])]
...
plt.plot(7600,np.min(spec_1_cal)+offsets[1],'*')
...
plt.title('ZTF19aadgimr', fontsize=20)
#plt.ylim(-16,-13.7)
plt.xlim(3000,11000)
...
plt.grid()
plt.tight_layout()
plt.savefig('spectra_ZTF19aadgimr.pdf', facecolor='w', edgecolor='w',orientation='portrait', papertype=None, format='pdf',transparent=False, bbox_inches='tight')
plt.show()
